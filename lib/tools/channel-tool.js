 ...
 */
export function createChannelTool({ channelsDir, agentsDir, agentId, listAgents, onPost, isEnabled }) {
  return {
    name: "channel",
    ...
    execute: async (_toolCallId, params) => {
      ...
      switch (params.action) {
        ...
        case "post": {
          ...
          const { timestamp } = await appendMessage(channelFile, agentId, params.content);
